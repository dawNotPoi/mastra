...
- dependencies updates: ([#17846](https://github.com/mastra-ai/mastra/pull/17846))
  - Updated dependency [`@arizeai/openinference-genai@0.2.0` ↗︎](https://www.npmjs.com/package/@arizeai/openinference-genai/v/0.2.0) (from `0.1.7`, in `dependencies`)
  - Updated dependency [`@arizeai/openinference-semantic-conventions@^2.5.0` ↗︎](https://www.npmjs.com/package/@arizeai/openinference-semantic-conventions/v/2.5.0) (from `^2.1.7`, in `dependencies`)
...
- dependencies updates: ([#12727](https://github.com/mastra-ai/mastra/pull/12727))
  - Updated dependency [`@arizeai/openinference-genai@0.1.6` ↗︎](https://www.npmjs.com/package/@arizeai/openinference-genai/v/0.1.6) (from `0.1.5`, in `dependencies`)
...
- Fixed incorrect span kind mapping in @mastra/arize. Workflow spans now correctly map to CHAIN, agent spans to AGENT, and tool spans to TOOL instead of defaulting to LLM. ([#12423](https://github.com/mastra-ai/mastra/pull/12423))
...
- When spaceId is provided to ArizeExporter constructor, and endpoint is not, pre-populate endpoint with default ArizeAX endpoint. ([#9240](https://github.com/mastra-ai/mastra/pull/9240))
...
- fix(@mastra/arize): Auto-detect arize endpoint when endpoint field is not provided ([#9240](https://github.com/mastra-ai/mastra/pull/9240))
