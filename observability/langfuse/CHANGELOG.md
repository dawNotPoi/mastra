...
- Use the GenAI semantic convention for reasoning output tokens so Langfuse does not double-count them with total output tokens. ([#24939](https://github.com/mastra-ai/mastra/pull/24939))
...
- Fixed Observational Memory session grouping in Langfuse, including observer and reflector spans received before their parent spans. ([#23459](https://github.com/mastra-ai/mastra/pull/23459))
...
- Added support for custom headers in Langfuse requests. ([#21951](https://github.com/mastra-ai/mastra/pull/21951))
...
- dependencies updates: ([#19783](https://github.com/mastra-ai/mastra/pull/19783))
  - Updated dependency [`@langfuse/client@^5.9.1` ↗︎](https://www.npmjs.com/package/@langfuse/client/v/5.9.1) (from `^5.4.1`, in `dependencies`)
  - Updated dependency [`@langfuse/otel@^5.9.1` ↗︎](https://www.npmjs.com/package/@langfuse/otel/v/5.9.1) (from `^5.4.1`, in `dependencies`)
...
- dependencies updates: ([#17846](https://github.com/mastra-ai/mastra/pull/17846))
  - Updated dependency [`@langfuse/client@^5.4.1` ↗︎](https://www.npmjs.com/package/@langfuse/client/v/5.4.1) (from `^5.0.2`, in `dependencies`)
  - Updated dependency [`@langfuse/otel@^5.4.1` ↗︎](https://www.npmjs.com/package/@langfuse/otel/v/5.4.1) (from `^5.0.2`, in `dependencies`)
...
- dependencies updates: ([#10149](https://github.com/mastra-ai/mastra/pull/10149))
  - Updated dependency [`langfuse@^3.38.6` ↗︎](https://www.npmjs.com/package/langfuse/v/3.38.6) (from `^3.38.5`, in `dependencies`)
...
- Fix orphaned spans in langfuse exporter ([#8104](https://github.com/mastra-ai/mastra/pull/8104))
...
- updated exporter to use a lightweight span for exporting ([#7764](https://github.com/mastra-ai/mastra/pull/7764))
...
- dependencies updates: ([#7714](https://github.com/mastra-ai/mastra/pull/7714))
  - Updated dependency [`langfuse@^3.38.5` ↗︎](https://www.npmjs.com/package/langfuse/v/3.38.5) (from `^3.38.4`, in `dependencies`)
