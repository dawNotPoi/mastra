...
- Added TTL-specific Anthropic cache-write token details alongside the aggregate LangSmith usage value. ([#21563](https://github.com/mastra-ai/mastra/pull/21563))
...
- dependencies updates: ([#19783](https://github.com/mastra-ai/mastra/pull/19783))
  - Updated dependency [`langsmith@^0.8.7` ↗︎](https://www.npmjs.com/package/langsmith/v/0.8.7) (from `^0.7.7`, in `dependencies`)
...
- dependencies updates: ([#16244](https://github.com/mastra-ai/mastra/pull/16244))
  - Updated dependency [`langsmith@^0.6.0` ↗︎](https://www.npmjs.com/package/langsmith/v/0.6.0) (from `^0.5.10`, in `dependencies`)

- dependencies updates: ([#17846](https://github.com/mastra-ai/mastra/pull/17846))
  - Updated dependency [`langsmith@^0.7.7` ↗︎](https://www.npmjs.com/package/langsmith/v/0.7.7) (from `^0.6.0`, in `dependencies`)
