...
- Fixed custom upload routes waiting for body parsing when no fine-grained authorization provider is configured. ([#24563](https://github.com/mastra-ai/mastra/pull/24563))
...
- Fixed server crashes when clients disconnect during streaming. ([#20312](https://github.com/mastra-ai/mastra/pull/20312))
...
- Fix "Body is unusable" error by caching request body in middleware ([#12222](https://github.com/mastra-ai/mastra/pull/12222))
