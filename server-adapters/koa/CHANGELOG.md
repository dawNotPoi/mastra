...
- Decode route parameters once before passing them to handlers. Percent-encoded skill names and reference paths now resolve consistently with other server adapters. ([#24637](https://github.com/mastra-ai/mastra/pull/24637))
...
- Preserved status, headers, and body content from explicitly attached HTTP exception responses. ([#22728](https://github.com/mastra-ai/mastra/pull/22728))
